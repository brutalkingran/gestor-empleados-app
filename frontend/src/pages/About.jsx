...
const About = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white shadow-lg rounded-lg p-8 dark:bg-indigo-800">
      <h1 className="text-3xl font-bold text-blue-900 mb-6 text-center dark:text-white">
